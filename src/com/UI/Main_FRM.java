...
public class Main_FRM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Buttonsetting.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/assets/settings_32px.png"))); // NOI18N
        ...
        buttonhidemenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/assets/menu_32px.png"))); // NOI18N
    ...
    public void hideshow(JPanel menushowhide, boolean dashboard, JLabel button) {
        if (dashboard == true) {
            ...
            FrameUtilities.setImagenToLbl(this, button, "src\\com\\assets\\menu_32px.png");
        } else {
            menushowhide.setPreferredSize(new Dimension(270, menushowhide.getHeight()));
            FrameUtilities.setImagenToLbl(this, button, "src\\com\\assets\\back_32px.png");
        }
